...
const testimonials: TTestimonial[] = [
  {
    testimonial:
      "The attention to detail and the seamless integration of complex AI features into our platform completely transformed our workflow. Highly recommended!",
    name: "Aarav Sharma",
    designation: "CEO",
  ...
  {
    testimonial:
      "Working with such a talented developer was a breeze. The technical expertise in the MERN stack ensured our project was delivered on time and exceeded expectations.",
    name: "Priya Desai",
  ...
  {
    testimonial:
      "Outstanding technically, but what really impressed us was the problem-solving ability. The scalable architecture built for us handles our user load flawlessly.",
    name: "Kabir Singh",
    designation: "Founder",
